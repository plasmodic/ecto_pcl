...
import ecto, ecto_pcl, ecto_pcl_ros, ecto_ros, ecto_sensor_msgs
import sys

plasm = ecto.Plasm()

sub = ecto_sensor_msgs.Subscriber_PointCloud2("Cloud Subscriber", topic_name='/camera/depth_registered/points')
...
pub = ecto_sensor_msgs.Publisher_PointCloud2("Cloud Publisher", topic_name='/ecto_pcl/sample_output')
